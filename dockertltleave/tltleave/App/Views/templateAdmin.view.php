    ...
    <main>
        <section id="sidebar">
            <ul>
                ...
                <li><a href="<?=URL?>usermanagement"><img src="\assets\images\icons\admin\userManagement.svg" alt="logo gestion des utilisateurs" class="circle"></a></li>
                <li><a href="<?=URL?>treatmentrequests"><img src="\assets\images\icons\admin\treatmentRequests.svg" alt="logo traitement des demandes" class="circle"></a></li>
